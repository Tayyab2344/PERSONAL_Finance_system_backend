...
router.post('/finance/transfer', authMiddleware, financeController.addTransfer);
router.get('/finance/transfer', authMiddleware, financeController.getTransfers);
router.put('/finance/transfer/:id', authMiddleware, financeController.updateTransfer);
router.delete('/finance/transfer/:id', authMiddleware, financeController.deleteTransfer);
